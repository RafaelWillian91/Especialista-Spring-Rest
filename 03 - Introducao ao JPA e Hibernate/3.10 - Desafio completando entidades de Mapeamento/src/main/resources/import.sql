...
insert into restaurante (nome, taxa_frete, cozinha_codigo) values ('Restaurante-Josi', 15, 1)
insert into restaurante (nome, taxa_frete, cozinha_codigo) values ('Restaurante-LuLu', 25, 2 )
insert into restaurante (nome, taxa_frete, cozinha_codigo) values ('Restaurante-loucosHermanos', 15, 1)
...
-- Relacionando restaurante com formas de pagamento
