...
values (1, 'bba9b671-15ad-48ae-80cf-0a33d76a6f7a', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'JD Brasil',
'CRIADO', '2016-04-10 22:00:30', '2016-04-20 09:01:21', '2019-11-02 21:20:10', 298.90, 10, 308.90);

insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
    status, data_criacao, data_confirmacao, data_entrega, subtotal, taxa_frete, valor_total)
       values (2, '2c72e128-cc0f-4ac6-879c-15c118a24ae7', 2, 2, 2, 1,
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
    status, data_criacao, data_confirmacao, data_entrega, subtotal, taxa_frete, valor_total)
    values (3, '48e79184-6272-4568-9ec5-5b8fbd2b6ede', 1, 3, 1, 1,
