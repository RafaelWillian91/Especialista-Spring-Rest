...
public class CozinhaController {
	...
	public Page<CozinhaDTO> listar(@PageableDefault (size = 2) Pageable pageable) {
		...
		List<CozinhaDTO> cozinhaDTOS =  cozinhaAssembler.toCollectionModel(cozinhasPage.getContent());

		Page<CozinhaDTO> cozinhaDTOPage = new PageImpl<>(cozinhaDTOS, pageable, cozinhasPage.getTotalElements());
