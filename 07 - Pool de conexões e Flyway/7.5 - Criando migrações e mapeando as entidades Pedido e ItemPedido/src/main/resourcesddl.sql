    ...
    create table pedido (
       id bigint not null auto_increment,
        ...
        pedido_restaurante_id bigint not null,
        primary key (id)
    ) engine=InnoDB;
    ...
    alter table pedido 
       add constraint FKdb10j9o1bfqkewn83mja84w93 
       foreign key (pedido_restaurante_id) 
    ...
    alter table usuario_grupo 
       add constraint FKgortji38indw4cfb70res8s3a 
       foreign key (grupo_usuario_id) 
       references grupo (id);

    alter table usuario_grupo 
       add constraint FKo96sxmj20h25lh1jt5fwf9ic4 
...
insert into restaurante_forma_pagamento (restaurante_id, forma_pagamento_id) values (1, 1), (1, 2), (1, 3), (2, 3), (3, 2), (3, 3), (4, 1), (4, 2), (5, 1), (5, 2), (6, 3);
    ...
    create table usuario_grupo (
       usuario_grupo_id bigint not null,
        ...
        primary key (usuario_grupo_id, grupo_usuario_id)
    ) engine=InnoDB;
