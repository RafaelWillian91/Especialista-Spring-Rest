...
public class UsuarioController {
    ...
    public void alterarSenha(@PathVariable Long usuarioId, @RequestBody @Valid SenhaUsuarioInput senha) {
        cadastroUsuario.alterarSenha(usuarioId, senha.getSenha(), senha.getNovaSenha());
    }
}
