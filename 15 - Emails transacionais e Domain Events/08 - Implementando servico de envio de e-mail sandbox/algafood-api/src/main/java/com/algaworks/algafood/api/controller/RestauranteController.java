...
public class RestauranteController {
    ...
    public Page<RestauranteDTO> listar(Pageable pageable) {
        Page<Restaurante> restaurantePage = restauranteRepository.findAll(pageable);

        List<RestauranteDTO> listRestauranteDTO = restauranteAssembler.toCollectionModel(restaurantePage.getContent());

        Page<RestauranteDTO> restauranteDTOPage = new PageImpl<>(listRestauranteDTO, pageable, restaurantePage.getTotalElements());
