...
create table usuario (id bigint not null auto_increment, data_criacao datetime not null, email varchar(255) not null, nome varchar(255) not null, senha varchar(255) not null, primary key (id)) engine=InnoDB;
create table usuario_grupo (usuario_grupo_id bigint not null, grupo_usuario_id bigint not null, primary key (usuario_grupo_id, grupo_usuario_id)) engine=InnoDB;
...
alter table usuario_grupo add constraint FKgortji38indw4cfb70res8s3a foreign key (grupo_usuario_id) references grupo (id);
alter table usuario_grupo add constraint FKo96sxmj20h25lh1jt5fwf9ic4 foreign key (usuario_grupo_id) references usuario (id);
