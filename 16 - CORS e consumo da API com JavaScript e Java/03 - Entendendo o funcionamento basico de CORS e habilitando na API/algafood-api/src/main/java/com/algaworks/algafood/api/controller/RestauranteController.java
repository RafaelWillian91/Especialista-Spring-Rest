...
public class RestauranteController {
    ...
    public ResponseEntity<List<RestauranteDTO>> listar() {
        ...
        List<RestauranteDTO> restauranteDTOS =  restauranteAssembler.toCollectionModel(restauranteRepository.findAll());

        return ResponseEntity.ok()
                .header(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN, "http://api.algafood.local:8000")
